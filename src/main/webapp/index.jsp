        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100 immaginiSlider" src="immagini/paesaggio1.jpg" alt="First slide" height="70%">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100 immaginiSlider" src="immagini/paesaggio2.jpg" alt="Second slide" height="70%">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100 immaginiSlider" src="immagini/paesaggio3.jpg" alt="Third slide" height="70%">
                </div>
            </div>
